...
#
#  options string: py:python3,asyncio,utf8strings
#
...
class Client(Iface):
  def __init__(self, transport, iprot_factory, oprot_factory=None):
    ...
    self._oprot = (oprot_factory if oprot_factory is not None
                           else iprot_factory).getProtocol(transport)
    self._seqid = 0
    self._reqs = {}
    self._task = asyncio.Task(self.recv_dispatch())

  @asyncio.coroutine
  def recv_dispatch(self):
    """read a response from the wire. Dispatch futures"""

    try:
      while True:
        frame = yield from self._transport.readFrame()
  ...
  def OpenSession(self, req):
    ...
    """
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_OpenSession(req)
  ...
  def send_OpenSession(self, req):
    ...
    yield from self._transport.flush()

  def recv_OpenSession(self, iprot, mtype, rseqid):
    future = self._reqs.pop(rseqid)
    ...
    if result.success is not None:
      ...
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "OpenSession failed: unknown result"))
    return
  ...
  def CloseSession(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_CloseSession(req)
    return (yield from future)
  ...
  def recv_CloseSession(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "CloseSession failed: unknown result"))
    return
  ...
  def GetInfo(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_GetInfo(req)
    return (yield from future)
  ...
  def recv_GetInfo(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "GetInfo failed: unknown result"))
    return
  ...
  def ExecuteStatement(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_ExecuteStatement(req)
    return (yield from future)
  ...
  def recv_ExecuteStatement(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "ExecuteStatement failed: unknown result"))
    return
  ...
  def GetTypeInfo(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_GetTypeInfo(req)
    return (yield from future)
  ...
  def recv_GetTypeInfo(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "GetTypeInfo failed: unknown result"))
    return
  ...
  def GetCatalogs(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_GetCatalogs(req)
    return (yield from future)
  ...
  def recv_GetCatalogs(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "GetCatalogs failed: unknown result"))
    return
  ...
  def GetSchemas(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_GetSchemas(req)
    return (yield from future)
  ...
  def recv_GetSchemas(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "GetSchemas failed: unknown result"))
    return
  ...
  def GetTables(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_GetTables(req)
    return (yield from future)
  ...
  def recv_GetTables(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "GetTables failed: unknown result"))
    return
  ...
  def GetTableTypes(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_GetTableTypes(req)
    return (yield from future)
  ...
  def recv_GetTableTypes(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "GetTableTypes failed: unknown result"))
    return
  ...
  def GetColumns(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_GetColumns(req)
    return (yield from future)
  ...
  def recv_GetColumns(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "GetColumns failed: unknown result"))
    return
  ...
  def GetFunctions(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_GetFunctions(req)
    return (yield from future)
  ...
  def recv_GetFunctions(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "GetFunctions failed: unknown result"))
    return
  ...
  def GetOperationStatus(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_GetOperationStatus(req)
    return (yield from future)
  ...
  def recv_GetOperationStatus(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "GetOperationStatus failed: unknown result"))
    return
  ...
  def CancelOperation(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_CancelOperation(req)
    return (yield from future)
  ...
  def recv_CancelOperation(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "CancelOperation failed: unknown result"))
    return
  ...
  def CloseOperation(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_CloseOperation(req)
    return (yield from future)
  ...
  def recv_CloseOperation(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "CloseOperation failed: unknown result"))
    return
  ...
  def GetResultSetMetadata(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_GetResultSetMetadata(req)
    return (yield from future)
  ...
  def recv_GetResultSetMetadata(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "GetResultSetMetadata failed: unknown result"))
    return
  ...
  def FetchResults(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_FetchResults(req)
    return (yield from future)
  ...
  def recv_FetchResults(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "FetchResults failed: unknown result"))
    return
  ...
  def GetDelegationToken(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_GetDelegationToken(req)
    return (yield from future)
  ...
  def recv_GetDelegationToken(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "GetDelegationToken failed: unknown result"))
    return
  ...
  def CancelDelegationToken(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_CancelDelegationToken(req)
    return (yield from future)
  ...
  def recv_CancelDelegationToken(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "CancelDelegationToken failed: unknown result"))
    return
  ...
  def RenewDelegationToken(self, req):
    ...
    self._seqid += 1
    future = self._reqs[self._seqid] = asyncio.Future()
    yield from self.send_RenewDelegationToken(req)
    return (yield from future)
  ...
  def recv_RenewDelegationToken(self, iprot, mtype, rseqid):
    ...
    if result.success is not None:
      future.set_result(result.success)
      return
    future.set_exception(TApplicationException(TApplicationException.MISSING_RESULT, "RenewDelegationToken failed: unknown result"))
    return
